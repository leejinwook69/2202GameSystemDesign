...
void GameManager::MovePlayer(char map[21][21], int start_x, int start_y) {
        ...
        {
            case UP:
                if ((start_y < 20) && (map[start_y - 1][start_x] == '0'))
                {
            ...
            case DOWN:
                if ((0 < start_y) && (map[start_y + 1][start_x] == '0'))
                {
                    map[start_y][start_x] = '0';
                    map[start_y + 1][start_x] = '2';
                    ypos++;
...
void GameManager::SetMap1(char map[21][21])
{
    ...
    strcpy_s(map[3] , "10100000101011010001");
    strcpy_s(map[4] , "10111110101011010101");
    ...
    strcpy_s(map[12], "10101010100000010001");
...
void GameManager::SetMap3(char map[21][21])
{
    ...
    strcpy_s(map[6] , "11000101010101010101");
    strcpy_s(map[7] , "11110111010001000101");
    strcpy_s(map[8] , "11010011011011111101");
...
void GameManager::SetMap6(char map[21][21])
{
    ...
    strcpy_s(map[7] , "10100011111011110101");
...
void GameManager::SetMap7(char map[21][21])
{
    ...
    strcpy_s(map[12], "10110001111010000001");
